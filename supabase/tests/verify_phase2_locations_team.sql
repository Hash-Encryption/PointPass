...
-- Fully self-contained: establishes Phase 2 DDL & Anti-Recursion RLS in-transaction
-- so it can be run before or after migration application.
-- ==============================================================================

BEGIN;

-- ------------------------------------------------------------------------------
-- 0. Anti-Recursion RLS Helpers & Policies (Rolls back automatically at the end)
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 0b. Establish Phase 2 DDL in Transaction (Rolls back automatically at the end)
-- ------------------------------------------------------------------------------
